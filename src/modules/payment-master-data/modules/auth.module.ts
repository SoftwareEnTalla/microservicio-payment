...
@Module({
  controllers: [PaymentMasterDataCommandController],
  providers: [
  ...
  exports: [PaymentMasterDataAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentMasterDataModule {}
