...
import { PaymentMasterDataCreatedEvent } from './paymentmasterdatacreated.event';
import { PaymentMasterDataUpdatedEvent } from './paymentmasterdataupdated.event';
import { PaymentMasterDataDeletedEvent } from './paymentmasterdatadeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'payment-master-data-created': createEventDefinition('payment-master-data-created', PaymentMasterDataCreatedEvent, EVENT_DEFINITION_OVERRIDES['payment-master-data-created']),
  'payment-master-data-updated': createEventDefinition('payment-master-data-updated', PaymentMasterDataUpdatedEvent, EVENT_DEFINITION_OVERRIDES['payment-master-data-updated']),
  'payment-master-data-deleted': createEventDefinition('payment-master-data-deleted', PaymentMasterDataDeletedEvent, EVENT_DEFINITION_OVERRIDES['payment-master-data-deleted']),
