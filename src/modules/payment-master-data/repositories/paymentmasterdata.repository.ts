...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class PaymentMasterDataRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[PaymentMasterData[], number]> {
      logger.info('Ready to findByField PaymentMasterData on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of PaymentMasterData with id:  was finded on repository:', instance);
