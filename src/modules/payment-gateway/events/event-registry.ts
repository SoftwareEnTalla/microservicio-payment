...
import { PaymentGatewayCreatedEvent } from './paymentgatewaycreated.event';
import { PaymentGatewayUpdatedEvent } from './paymentgatewayupdated.event';
import { PaymentGatewayDeletedEvent } from './paymentgatewaydeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'payment-gateway-created': createEventDefinition('payment-gateway-created', PaymentGatewayCreatedEvent, EVENT_DEFINITION_OVERRIDES['payment-gateway-created']),
  'payment-gateway-updated': createEventDefinition('payment-gateway-updated', PaymentGatewayUpdatedEvent, EVENT_DEFINITION_OVERRIDES['payment-gateway-updated']),
  'payment-gateway-deleted': createEventDefinition('payment-gateway-deleted', PaymentGatewayDeletedEvent, EVENT_DEFINITION_OVERRIDES['payment-gateway-deleted']),
