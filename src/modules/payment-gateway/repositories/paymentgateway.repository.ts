...
import { logger } from '@core/logs/logger';
  ...
  export class PaymentGatewayRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[PaymentGateway[], number]> {
      logger.info('Ready to findByField PaymentGateway on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of PaymentGateway with id:  was finded on repository:', instance);
