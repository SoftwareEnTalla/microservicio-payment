...
@Module({
  controllers: [PaymentGatewayCommandController],
  providers: [
  ...
  exports: [PaymentGatewayAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentGatewayModule {}
