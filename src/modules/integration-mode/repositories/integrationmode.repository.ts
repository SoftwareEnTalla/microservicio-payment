...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class IntegrationModeRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[IntegrationMode[], number]> {
      logger.info('Ready to findByField IntegrationMode on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of IntegrationMode with id:  was finded on repository:', instance);
