...
import { IntegrationModeCreatedEvent } from './integrationmodecreated.event';
import { IntegrationModeUpdatedEvent } from './integrationmodeupdated.event';
import { IntegrationModeDeletedEvent } from './integrationmodedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'integration-mode-created': createEventDefinition('integration-mode-created', IntegrationModeCreatedEvent, EVENT_DEFINITION_OVERRIDES['integration-mode-created']),
  'integration-mode-updated': createEventDefinition('integration-mode-updated', IntegrationModeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['integration-mode-updated']),
  'integration-mode-deleted': createEventDefinition('integration-mode-deleted', IntegrationModeDeletedEvent, EVENT_DEFINITION_OVERRIDES['integration-mode-deleted']),
