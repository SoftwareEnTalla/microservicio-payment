...
@Injectable()
export class PaymentMerchantGatewayEligibilityStatusGuard implements CanActivate {
  private readonly logger = new Logger(PaymentMerchantGatewayEligibilityStatusGuard.name);
