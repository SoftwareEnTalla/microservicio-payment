...
@Injectable()
export class PaymentMerchantGatewayEligibilityStatusAuthGuard implements CanActivate {
  private readonly logger = new Logger(PaymentMerchantGatewayEligibilityStatusAuthGuard.name);
