...
import { PaymentMerchantGatewayEligibilityStatusCreatedEvent } from './paymentmerchantgatewayeligibilitystatuscreated.event';
import { PaymentMerchantGatewayEligibilityStatusUpdatedEvent } from './paymentmerchantgatewayeligibilitystatusupdated.event';
import { PaymentMerchantGatewayEligibilityStatusDeletedEvent } from './paymentmerchantgatewayeligibilitystatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'payment-merchant-gateway-eligibility-status-created': createEventDefinition('payment-merchant-gateway-eligibility-status-created', PaymentMerchantGatewayEligibilityStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['payment-merchant-gateway-eligibility-status-created']),
  'payment-merchant-gateway-eligibility-status-updated': createEventDefinition('payment-merchant-gateway-eligibility-status-updated', PaymentMerchantGatewayEligibilityStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['payment-merchant-gateway-eligibility-status-updated']),
  'payment-merchant-gateway-eligibility-status-deleted': createEventDefinition('payment-merchant-gateway-eligibility-status-deleted', PaymentMerchantGatewayEligibilityStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['payment-merchant-gateway-eligibility-status-deleted']),
