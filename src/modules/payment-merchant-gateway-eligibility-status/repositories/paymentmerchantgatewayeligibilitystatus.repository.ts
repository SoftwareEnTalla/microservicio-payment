...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class PaymentMerchantGatewayEligibilityStatusRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[PaymentMerchantGatewayEligibilityStatus[], number]> {
      logger.info('Ready to findByField PaymentMerchantGatewayEligibilityStatus on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of PaymentMerchantGatewayEligibilityStatus with id:  was finded on repository:', instance);
