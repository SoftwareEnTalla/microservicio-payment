...
@Module({
  controllers: [PaymentMerchantGatewayEligibilityStatusCommandController],
  providers: [
  ...
  exports: [PaymentMerchantGatewayEligibilityStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentMerchantGatewayEligibilityStatusModule {}
