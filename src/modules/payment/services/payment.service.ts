...
export class PaymentService {
  ...
  // Métodos delegados
  async findAll(options?: any): Promise<Payment[]> {
  ...
  async findByField(field: string, value: any, page: number, limit: number): Promise<Payment[]> {
    return this.repository.findByField(field, value, page, limit);
  }

  async findWithPagination(options: any, page: number, limit: number): Promise<Payment[]> {
  ...
  async update(id: string, partialEntity: Partial<Payment>): Promise<Payment | null> {
