...
@Injectable()
export class PaymentCustomerGatewayEligibilityService {
  constructor(private readonly repository: PaymentCustomerGatewayEligibilityRepository) {}

  // Métodos delegados
  async findAll(options?: any): Promise<PaymentCustomerGatewayEligibility[]> {
  ...
  async findByField(field: string, value: any, page: number, limit: number): Promise<PaymentCustomerGatewayEligibility[]> {
    return this.repository.findByField(field, value, page, limit);
  }

  async findWithPagination(options: any, page: number, limit: number): Promise<PaymentCustomerGatewayEligibility[]> {
  ...
  async findOne(where?: Record<string, any>): Promise<PaymentCustomerGatewayEligibility | null> {
  ...
  async update(id: string, partialEntity: Partial<PaymentCustomerGatewayEligibility>): Promise<PaymentCustomerGatewayEligibility | null> {
