...
import {
  PaymentCustomerGatewayEligibilityCreatedEvent,
  PaymentCustomerGatewayEligibilityUpdatedEvent,
  PaymentCustomerGatewayEligibilityDeletedEvent,
...
export class PaymentCustomerGatewayEligibilityCrudSaga {
  ...
  @Saga()
  onPaymentCustomerGatewayEligibilityCreated = ($events: Observable<PaymentCustomerGatewayEligibilityCreatedEvent>) => {
    return $events.pipe(
  ...
  @Saga()
  onPaymentCustomerGatewayEligibilityUpdated = ($events: Observable<PaymentCustomerGatewayEligibilityUpdatedEvent>) => {
    return $events.pipe(
  ...
  @Saga()
  onPaymentCustomerGatewayEligibilityDeleted = ($events: Observable<PaymentCustomerGatewayEligibilityDeletedEvent>) => {
    return $events.pipe(
