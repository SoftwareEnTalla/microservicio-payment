...
@Module({
  controllers: [PaymentCustomerGatewayEligibilityCommandController],
  providers: [
  ...
  exports: [PaymentCustomerGatewayEligibilityAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentCustomerGatewayEligibilityModule {}
