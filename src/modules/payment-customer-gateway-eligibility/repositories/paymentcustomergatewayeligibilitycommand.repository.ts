...
export class PaymentCustomerGatewayEligibilityCommandRepository implements IEventHandler<BaseEvent>{
  ...
  async create(entity: PaymentCustomerGatewayEligibility): Promise<PaymentCustomerGatewayEligibility> {
    ...
    if (this.shouldPublishEvent()) {
      this.eventPublisher.publish(new PaymentCustomerGatewayEligibilityCreatedEvent(result.id, {
        instance: result,
        metadata: {
  ...
  async bulkCreate(entities: PaymentCustomerGatewayEligibility[]): Promise<PaymentCustomerGatewayEligibility[]> {
    ...
    if (this.shouldPublishEvent()) {
      this.eventPublisher.publishAll(result.map((el)=>new PaymentCustomerGatewayEligibilityCreatedEvent(el.id, {
        instance: el,
        metadata: {
  ...
  async update(
    ...
    if(instance && this.shouldPublishEvent()) {
      ...
      this.eventPublisher.publish(new PaymentCustomerGatewayEligibilityUpdatedEvent(instance.id, {
          instance: instance,
          metadata: {
    ...
    for (const entity of entities) {
      if (entity.id) {
        ...
        if (updatedEntity) {
          ...
          if (this.shouldPublishEvent()) {
            this.eventPublisher.publish(new PaymentCustomerGatewayEligibilityUpdatedEvent(updatedEntity.id, {
  ...
  async delete(id: string): Promise<DeleteResult> {
     ...
     if (this.shouldPublishEvent()) {
       ...
       this.eventPublisher.publish(new PaymentCustomerGatewayEligibilityDeletedEvent(id, {
        instance: entity,
        metadata: {
