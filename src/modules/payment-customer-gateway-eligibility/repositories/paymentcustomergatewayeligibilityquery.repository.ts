...
import { logger } from '@core/logs/logger';
  ...
  export class PaymentCustomerGatewayEligibilityQueryRepository {
    ...
    async findOne(where?: Record<string, any>): Promise<PaymentCustomerGatewayEligibility | null> {
      const tmp: FindOptionsWhere<PaymentCustomerGatewayEligibility> = where as FindOptionsWhere<PaymentCustomerGatewayEligibility>;
      logger.info('Ready to findOneBy PaymentCustomerGatewayEligibility on repository with conditions:', tmp);
