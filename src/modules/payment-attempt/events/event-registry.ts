...
import { PaymentAttemptCreatedEvent } from './paymentattemptcreated.event';
import { PaymentAttemptUpdatedEvent } from './paymentattemptupdated.event';
import { PaymentAttemptDeletedEvent } from './paymentattemptdeleted.event';
import { PaymentFailedEvent } from './paymentfailed.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'payment-attempt-created': createEventDefinition('payment-attempt-created', PaymentAttemptCreatedEvent, EVENT_DEFINITION_OVERRIDES['payment-attempt-created']),
  'payment-attempt-updated': createEventDefinition('payment-attempt-updated', PaymentAttemptUpdatedEvent, EVENT_DEFINITION_OVERRIDES['payment-attempt-updated']),
  'payment-attempt-deleted': createEventDefinition('payment-attempt-deleted', PaymentAttemptDeletedEvent, EVENT_DEFINITION_OVERRIDES['payment-attempt-deleted']),
  'payment-failed': createEventDefinition('payment-failed', PaymentFailedEvent, EVENT_DEFINITION_OVERRIDES['payment-failed']),
};
