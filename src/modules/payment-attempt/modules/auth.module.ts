...
@Module({
  controllers: [PaymentAttemptCommandController],
  providers: [
  ...
  exports: [PaymentAttemptAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentAttemptModule {}
