...
import { logger } from '@core/logs/logger';
  ...
  export class PaymentAttemptRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[PaymentAttempt[], number]> {
      logger.info('Ready to findByField PaymentAttempt on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of PaymentAttempt with id:  was finded on repository:', instance);
