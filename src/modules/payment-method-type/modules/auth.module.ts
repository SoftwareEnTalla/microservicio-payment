...
@Module({
  controllers: [PaymentMethodTypeCommandController],
  providers: [
  ...
  exports: [PaymentMethodTypeAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentMethodTypeModule {}
