...
import { PaymentMethodTypeCreatedEvent } from './paymentmethodtypecreated.event';
import { PaymentMethodTypeUpdatedEvent } from './paymentmethodtypeupdated.event';
import { PaymentMethodTypeDeletedEvent } from './paymentmethodtypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'payment-method-type-created': createEventDefinition('payment-method-type-created', PaymentMethodTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['payment-method-type-created']),
  'payment-method-type-updated': createEventDefinition('payment-method-type-updated', PaymentMethodTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['payment-method-type-updated']),
  'payment-method-type-deleted': createEventDefinition('payment-method-type-deleted', PaymentMethodTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['payment-method-type-deleted']),
