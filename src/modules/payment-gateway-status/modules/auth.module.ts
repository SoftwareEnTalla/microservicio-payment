...
@Module({
  controllers: [PaymentGatewayStatusCommandController],
  providers: [
  ...
  exports: [PaymentGatewayStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentGatewayStatusModule {}
