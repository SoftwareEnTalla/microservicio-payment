...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class PaymentGatewayStatusRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[PaymentGatewayStatus[], number]> {
      logger.info('Ready to findByField PaymentGatewayStatus on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of PaymentGatewayStatus with id:  was finded on repository:', instance);
