...
import { PaymentGatewayStatusCreatedEvent } from './paymentgatewaystatuscreated.event';
import { PaymentGatewayStatusUpdatedEvent } from './paymentgatewaystatusupdated.event';
import { PaymentGatewayStatusDeletedEvent } from './paymentgatewaystatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'payment-gateway-status-created': createEventDefinition('payment-gateway-status-created', PaymentGatewayStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['payment-gateway-status-created']),
  'payment-gateway-status-updated': createEventDefinition('payment-gateway-status-updated', PaymentGatewayStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['payment-gateway-status-updated']),
  'payment-gateway-status-deleted': createEventDefinition('payment-gateway-status-deleted', PaymentGatewayStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['payment-gateway-status-deleted']),
