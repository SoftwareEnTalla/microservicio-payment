...
@Module({
  controllers: [PaymentMerchantGatewayEligibilityCommandController],
  providers: [
  ...
  exports: [PaymentMerchantGatewayEligibilityAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentMerchantGatewayEligibilityModule {}
