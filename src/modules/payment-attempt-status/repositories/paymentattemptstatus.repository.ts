...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class PaymentAttemptStatusRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[PaymentAttemptStatus[], number]> {
      logger.info('Ready to findByField PaymentAttemptStatus on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of PaymentAttemptStatus with id:  was finded on repository:', instance);
