...
@Module({
  controllers: [PaymentAttemptStatusCommandController],
  providers: [
  ...
  exports: [PaymentAttemptStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentAttemptStatusModule {}
