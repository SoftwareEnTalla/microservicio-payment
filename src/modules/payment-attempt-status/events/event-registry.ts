...
import { PaymentAttemptStatusCreatedEvent } from './paymentattemptstatuscreated.event';
import { PaymentAttemptStatusUpdatedEvent } from './paymentattemptstatusupdated.event';
import { PaymentAttemptStatusDeletedEvent } from './paymentattemptstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'payment-attempt-status-created': createEventDefinition('payment-attempt-status-created', PaymentAttemptStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['payment-attempt-status-created']),
  'payment-attempt-status-updated': createEventDefinition('payment-attempt-status-updated', PaymentAttemptStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['payment-attempt-status-updated']),
  'payment-attempt-status-deleted': createEventDefinition('payment-attempt-status-deleted', PaymentAttemptStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['payment-attempt-status-deleted']),
