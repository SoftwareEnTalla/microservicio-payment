...
@Module({
  controllers: [PaymentStatusCommandController],
  providers: [
  ...
  exports: [PaymentStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentStatusModule {}
