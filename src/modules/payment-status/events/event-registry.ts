...
import { PaymentStatusCreatedEvent } from './paymentstatuscreated.event';
import { PaymentStatusUpdatedEvent } from './paymentstatusupdated.event';
import { PaymentStatusDeletedEvent } from './paymentstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'payment-status-created': createEventDefinition('payment-status-created', PaymentStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['payment-status-created']),
  'payment-status-updated': createEventDefinition('payment-status-updated', PaymentStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['payment-status-updated']),
  'payment-status-deleted': createEventDefinition('payment-status-deleted', PaymentStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['payment-status-deleted']),
