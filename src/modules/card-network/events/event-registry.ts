...
import { CardNetworkCreatedEvent } from './cardnetworkcreated.event';
import { CardNetworkUpdatedEvent } from './cardnetworkupdated.event';
import { CardNetworkDeletedEvent } from './cardnetworkdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'card-network-created': createEventDefinition('card-network-created', CardNetworkCreatedEvent, EVENT_DEFINITION_OVERRIDES['card-network-created']),
  'card-network-updated': createEventDefinition('card-network-updated', CardNetworkUpdatedEvent, EVENT_DEFINITION_OVERRIDES['card-network-updated']),
  'card-network-deleted': createEventDefinition('card-network-deleted', CardNetworkDeletedEvent, EVENT_DEFINITION_OVERRIDES['card-network-deleted']),
